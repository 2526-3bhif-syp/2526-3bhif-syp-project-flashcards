...
public class SidebarView extends VBox {
    ...
    public SidebarView() {
        ...
        this.setSpacing(10); // Etwas engerer Abstand für die Icons
        this.setPadding(new Insets(10, 0, 15, 0)); // Weniger Padding oben für "ganz oben" Start
        this.setAlignment(Pos.TOP_CENTER);
        this.setStyle("-fx-background-color: white;");

        // Obere Navigations-Elemente (beginnen ganz oben)
        ...
        // Spacer schiebt alles nachfolgende nach unten
